...
class TestAccessNestedMap(unittest.TestCase):
    ...
    def test_access_nested_map_exception(self, nested_map, path, expected_key):
        """Test that access_nested_map raises KeyError with expected message for invalid paths."""
...
class TestGetJson(unittest.TestCase):
    ...
    makes HTTP requests and returns JSON data without making actual external calls.
    """
